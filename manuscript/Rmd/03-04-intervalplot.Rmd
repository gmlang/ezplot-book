...
In the previous section, we learned how to make boxplot. If you go back and look at the boxplots we made, you'll realize a boxplot actually visualizes a lot of information, for example, it shows the median, the 
...
```{r, boxplot_bt_vs_year_cat_p4, fig.cap="Distribution of Budget Over the Years"}
