...
```{r, hist_budget, fig.cap="Histogram of budget", dpi=300, fig.width=4, fig.height=4}
...
```{r, density_budget, fig.cap="Density plot of budget", dpi=300, fig.width=4, fig.height=4}
...
```{r, cdf_budget, fig.cap="CDF plot of budget", dpi=300, fig.width=4, fig.height=4}
...
```{r, box_budget, fig.cap="Boxplot of budget", dpi=300, fig.width=4, fig.height=4}
...
```{r, qq_budget, fig.cap="Normal probability plot of budget", dpi=300, fig.width=4, fig.height=4}
plt = mk_qqplot(films) 
plt("budget") 
```
...
```{r, hist_log_budget, fig.cap="Histogram of log(budget)", dpi=300, fig.width=4, fig.height=4}
...
```{r, density_log_budget, fig.cap="Density of log(budget)", dpi=300, fig.width=4, fig.height=4}
plt2("log_budget", type = 'density', adjust = 0.6, legend_pos = 'bottom') 
```

```{r, cdf_log_budget, fig.cap="CDF of log(budget)", dpi=300, fig.width=4, fig.height=4}
plt2 = mk_cdfplot(films)
plt2("log_budget", add_vline_median = TRUE)
```

```{r, boxplot_log_budget, fig.cap="Boxplot of log(budget)", dpi=300, fig.width=4, fig.height=4}
plt2 = mk_boxplot(films)
plt2(yvar = "log_budget")
```

```{r, qq_log_budget, fig.cap="Normal probability plot of log(budget)", dpi=300, fig.width=4, fig.height=4}
