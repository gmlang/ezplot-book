...
```{r, barploth_freq_mpaa_cnt, fig.cap="", dpi=300, fig.width=4, fig.height=4} 
plt("mpaa", yorder = "descend", label_decimals = 2, label_size = 2, 
    font_size = 8)
```      

```{r, barploth_freq_mpaa_pct, fig.cap="", dpi=300, fig.width=4, fig.height=4} 
plt("mpaa", show_pct = TRUE, yorder = "descend", label_size = 2, font_size = 8) 
```

```{r, barploth_dodged, fig.cap="", dpi=300, fig.width=4, fig.height=4} 
plt(yvar = "year_cat", fillby = "made_money", label_size = 2, font_size = 8) 
```  

```{r, barploth_stacked, fig.cap="", dpi=300, fig.width=4, fig.height=4} 
...
```{r, barploth_vs_lollipop_p1, fig.cap="", dpi=300, fig.width=7, fig.height=7} 
plt = mk_barploth_resp(df)
...
```{r, barploth_vs_lollipop_p2, fig.cap="", dpi=300, fig.width=7, fig.height=7} 
plt = mk_lollipop(df)
