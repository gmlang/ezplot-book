...
```{r, cdfplot_simu, fig.cap="", dpi=300, fig.width=5, fig.height=5}
library(dplyr)
library(ezplot)
set.seed(123923)
...
```{r, cdfplot_time_bw_births, fig.cap="", dpi=300, fig.width=5, fig.height=5}
set.seed(9203)
...
```{r, ccdfplot_time_bw_births, fig.cap="", dpi=300, fig.width=5, fig.height=5}
