...
```{r, cdfplot_simu, fig.cap="Empirical CDFs of normal and t random samples", dpi=300, fig.width=7, fig.height=7}
library(dplyr)
library(ezplot)
set.seed(123923)
...
```{r, cdfplot_time_bw_births, fig.cap="Empirical CDF of time between births", dpi=300, fig.width=7, fig.height=7}
set.seed(9203)
...
```{r, ccdfplot_time_bw_births, fig.cap="Compliment CDF of time between births", dpi=300, fig.width=7, fig.height=7}
