...
```{r, barplot_resp_mpaa_cnt, fig.cap="Frequency of MPAA", dpi=300, fig.width=7, fig.height=7} 
...
```{r, barplot_resp_mpaa_pct, fig.cap="Relative Frequency of MPAA", dpi=300, fig.width=7, fig.height=7}   
...
```{r, barplot_resp_mpaa_cnt_p2, fig.cap="Frequency of MPAA", dpi=300, fig.width=7, fig.height=7} 
...
```{r, barplot_mpaa_vs_bo, fig.cap="Boxoffice by MPAA", dpi=300, fig.width=7, fig.height=7} 
