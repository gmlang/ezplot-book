...
```{r, barplot_freq_mpaa_cnt_p1, fig.cap="Frequency of MPAA", dpi=300, fig.width=7, fig.height=7} 
...
```{r, barplot_freq_mpaa_cnt_p2, fig.cap="Frequency of MPAA", dpi=300, fig.width=7, fig.height=7} 
...
```{r, barplot_freq_mpaa_pct, fig.cap="Relative Frequency of MPAA", dpi=300, fig.width=7, fig.height=7} 
