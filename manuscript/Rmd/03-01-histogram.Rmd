...
```{r, hist_rating_p1, fig.cap="Avg. Ratings with Mean Line"}
...
```{r, hist_rating_p2, fig.cap="Avg. Ratings with Mean and Median Lines"}
p = plt("rating", binw=0.3, xlab="IMDB Users' Average Rating", main=title,
...
```{r, hist_rating_by_made_money_cb, fig.cap="Avg. Ratings of Two Film Groups, Color-blind Friendly"}
