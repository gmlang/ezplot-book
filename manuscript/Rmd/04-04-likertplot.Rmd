...
```{r, likert_mpaa_cnt, fig.cap="Frequencies of Profitable vs. Unprofitable Films for each MPAA rating", dpi=300, fig.width=7, fig.height=7} 
library(ezplot)
library(dplyr)
...
```{r, likert_mpaa_pct, fig.cap="Percents of Profitable vs. Unprofitable Films for each MPAA rating", dpi=300, fig.width=7, fig.height=7} 
...
```{r, likert_north_sppInv, fig.cap="sppInv by type for each item", dpi=300, fig.width=7, fig.height=7} 
...
```{r, likert_north_spp, fig.cap="spp by type for each item", dpi=300, fig.width=7, fig.height=7} 
...
```{r, likert_ab3, fig.cap="12 Arabic Countries Economic Outlook Survey Results", dpi=300, fig.width=7, fig.height=7} 
