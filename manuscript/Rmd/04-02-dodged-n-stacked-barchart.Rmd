...
```{r, barplot_dodged, fig.cap="Number of Profitable vs. Unprofitable Films for Each Time Period", dpi=300, fig.width=7, fig.height=7} 
library(ezplot)
...
```{r, barplot_stacked, fig.cap="Percents of Profitable vs. Unprofitable Films for Each Time Period", dpi=300, fig.width=7, fig.height=7} 
...
```{r, barplot_dodged_p2, fig.cap="Number of Films at Each Period between Profitable and Unprofitable Films", dpi=300, fig.width=7, fig.height=7} 
...
```{r, barplot_dodged_p3, fig.cap="Votes of Profitable and Unprofitable Films for each MAPP rating", dpi=300, fig.width=7, fig.height=7} 
