...
```{r, lineplot_bobt, fig.cap="Annual Mean Budget and Boxoffice 1913-2014", dpi=300, fig.width=7, fig.height=7} 
library(ezplot)
...
```{r, lineplot_bobt_ratio, fig.cap="Boxoffice/Budget Ratio 1913-2014", dpi=300, fig.width=7, fig.height=7} 
library(dplyr)
library(tidyr)
...
```{r, lineplot_films, fig.cap="Films at 4 periods 1913 - 2014", dpi=300, fig.width=7, fig.height=7} 
...
```{r, power_n_ssize, fig.cap="Power & Sample Sizes", dpi=300, fig.width=7, fig.height=7}
