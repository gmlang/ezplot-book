...
```{r, dumbbell_fake, fig.cap="lt vs. rt across trt", dpi=300, fig.width=7, fig.height=7} 
plt = mk_dumbbell(df)
...
```{r, dumbbell_sm_p1, fig.cap="Social Media Usage of 2 Age Groups", dpi=300, fig.width=7, fig.height=7} 
plt = mk_dumbbell(df)
...
```{r, dumbbell_sm_p2, fig.cap="Social Media Usage of 2 Age Groups", dpi=300, fig.width=7, fig.height=7} 
