...
```{r, dumbbell_fake, fig.cap="lt vs. rt across trt"} 
plt = mk_dumbbell(df)
...
```{r, dumbbell_sm_p1, fig.cap="Social Media Usage of 2 Age Groups"} 
plt = mk_dumbbell(df)
...
```{r, dumbbell_sm_p2, fig.cap="Social Media Usage of 2 Age Groups"} 
