...
```{r, hist_rating_p1, dpi=300, fig.width=5, fig.height=5}
...
```{r, hist_rating_p2, dpi=300, fig.width=5, fig.height=5}
...
```{r, hist_rating_by_made_money, dpi=300, fig.width=5, fig.height=5}
