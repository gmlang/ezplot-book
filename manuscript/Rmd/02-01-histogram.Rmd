...
```{r, hist_rating_p1, fig.cap="Avg. Ratings with Mean and Median Lines", dpi=300, fig.width=7, fig.height=7}
...
```{r, hist_rating_p2, fig.cap="Avg. Ratings with Mean Line", dpi=300, fig.width=7, fig.height=7}
...
```{r, hist_rating_by_made_money, fig.cap="Avg. Ratings of Two Film Groups", dpi=300, fig.width=7, fig.height=7}
