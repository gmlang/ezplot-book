...
opts_chunk$set(comment = "", warning = FALSE, message = FALSE, tidy = FALSE,
               echo = TRUE, fig.align="center", fig.width = 6, fig.height = 6, 
               dev = 'png')
...
```{r, dist_budget, fig.path='images/', fig.cap=""}
...
```{r, dist_bo, fig.path='images/', fig.cap=""}
...
```{r, dist_log_budget, fig.path='images/', fig.cap=""}
