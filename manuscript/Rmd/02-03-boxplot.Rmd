...
```{r, boxplot_bt_vs_year_cat_p1, fig.cap="Distribution of budget over the decades"}
...
```{r, boxplot_bt_vs_year_p1, fig.cap="Distribution of budget 2010 - 2014"}
plt = mk_boxplot(
...
```{r, boxplot_rating_vs_year_cat_by_made_money, fig.cap="Distribution of avg ratings, profitable vs. unprofitable films."}
plt = mk_boxplot(films)
