...
```{r, boxplot_budget, fig.cap="Distribution of budget", dpi=300, fig.width=7, fig.height=7}
...
```{r, boxplot_bt_vs_year_cat_p1, fig.cap="Distribution of budget over the decades", dpi=300, fig.width=7, fig.height=7}
...
```{r, boxplot_bt_vs_year_p1, fig.cap="Distribution of budget 2010 - 2014", dpi=300, fig.width=7, fig.height=7}
plt = mk_boxplot(
...
```{r, boxplot_rating_vs_year_cat_by_made_money, fig.cap="Distribution of avg ratings, profitable vs. unprofitable films", dpi=300, fig.width=7, fig.height=7}
plt = mk_boxplot(films)
