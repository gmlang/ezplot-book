...
```{r, scatterplot_bo_vs_bt, fig.cap="Boxoffice vs. Budget", dpi=300, fig.width=7, fig.height=7}
...
```{r, scatterplot_bo_vs_bt_wline, fig.cap="Boxoffice vs. Budget", dpi=300, fig.width=7, fig.height=7}
add_lm_line(p)
```
...
```{r, scatterplot_bo_vs_votes, fig.cap="Boxoffice vs. Votes", dpi=300, fig.width=7, fig.height=7}
...
```{r, scatterplot_bo_vs_votes_tb, fig.cap="Boxoffice vs. Votes", dpi=300, fig.width=7, fig.height=7}
...
```{r, scatterplot_bo_vs_bt_color_by_action, fig.cap="Boxoffice vs. Budget colored by action film indicator", dpi=300, fig.width=7, fig.height=7}
