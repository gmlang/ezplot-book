...
```{r, density_length, fig.cap="Empirical PDF of film length", dpi=300, fig.width=7, fig.height=7}
library(ezplot)
...
```{r, density_length_by_made_money, fig.cap="Empirical PDF of film length by two groups", dpi=300, fig.width=7, fig.height=7}
...
```{r, density_rating_by_year_cat, fig.cap="Empirical PDF of film length by decades", dpi=300, fig.width=7, fig.height=7}
