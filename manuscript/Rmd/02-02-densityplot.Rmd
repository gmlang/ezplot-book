...
```{r, density_length, dpi=300, fig.width=5, fig.height=5}
library(ezplot)
...
```{r, density_length_by_made_money, dpi=300, fig.width=5, fig.height=5}
...
```{r, density_rating_by_year_cat, dpi=300, fig.width=5, fig.height=5}
