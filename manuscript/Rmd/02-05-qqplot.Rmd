...
```{r, qqplot_smp_p1, fig.cap="Q-Q plot of standard normal sample data with point-wise confidence band", dpi=300, fig.width=7, fig.height=7}
library(ezplot)
library(dplyr)
set.seed(0)
...
```{r, qqplot_smp_p2, fig.cap="Q-Q plot of standard normal sample data with tail-sensitive confidence band", dpi=300, fig.width=7, fig.height=7}
...
```{r, qqplot_ozone, fig.cap="Exponential Q-Q Plot of Ozone Levels", dpi=300, fig.width=7, fig.height=7}
