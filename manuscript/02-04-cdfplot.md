...
plt = mk_cdfplot(df)
plt('x', colorby='type', add_vline_median = TRUE, font_size = 8, 
    linew = 0.5, legend_title = NULL, legend_pos = 'top', pad = FALSE) %>% 
        square_fig()
```
...
f = mk_cdfplot(dat)
f("diffs", colorby = 'type', pad = F, font_size = 8, linew = 0.5, 
...
f("diffs", complement = TRUE, colorby = 'type', pad = FALSE, 
  legend_title = NULL, legend_pos = 'top', font_size = 8, linew = 0.5,  
  add_vline_median = T, show_label_median = F) %>%
